        ...
        <nav class="flex flex-col w-full">
          <div class="flex flex-wrap justify-between items-center px-6 py-4 w-full bg-white border-opacity-40 shadow-[0px_1px_1px_rgba(0,0,0,0.13)]">
            ...
            <div class="flex-1 flex flex-wrap gap-4 items-center justify-center text-sm font-semibold text-black">
              ...
              <a href="#" @click="openModal" class="py-2 hover:text-blue-600 transition duration-200 ease-in-out">Přehled nabídky</a>
            ...
            <div class="flex gap-4 items-center py-2 text-sm text-blue-600 rounded-full">
              ...
              <div class="relative">
                ...
                <transition name="fade" mode="out-in">
                  <ul v-if="dropdownOpen" class="dropdown absolute right-0 mt-2 w-48 bg-white shadow-lg rounded-md py-1 z-50">
                    <li class="flex items-center gap-2 px-4 py-2 hover:bg-gray-100 transition duration-200 ease-in-out">
                      <img src="/cz.svg" alt="Option Icon" class="w-6 h-6 object-contain" />
                      Option 1
                    </li>
                    <li class="flex items-center gap-2 px-4 py-2 hover:bg-gray-100 transition duration-200 ease-in-out">
                      <img src="/cz.svg" alt="Option Icon" class="w-6 h-6 object-contain" />
