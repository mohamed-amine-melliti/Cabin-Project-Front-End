<template>
  <div class="bg-white shadow-xl rounded-lg overflow-hidden">
    ...
    <div class="p-4">
      <p class="uppercase tracking-wide text-sm font-bold text-gray-700"> {{ listing.title }} • {{ reservationDate ||
        listing.category }}
      </p>
    ...
    <div class="flex p-4 border-t border-gray-300 text-gray-700">
      <div class="flex-1 inline-flex items-center">
        ...
        <p><span class="text-gray-900 font-bold">{{ roomCount }} </span> Bedrooms</p>
      </div>
      <div class="flex-1 inline-flex items-center">
        <svg class="h-6 w-6 text-gray-600 fill-current mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <p><span class="text-gray-900 font-bold">{{ roomCount }}</span> Bathrooms</p>
      </div>
    </div>
...
import type { AuthUser, Listing, Reservation } from '~/types'; // Make sure to import necessary types

// Define your props types
type UserInfoProps = {
  user: AuthUser;
};
